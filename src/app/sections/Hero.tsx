    ...
    <div className="relative">
      ...
      <div className="relative z-10">
        <div className="relative mb-[70px]">
          <section className="relative lg:h-[600px] md:h-[400px] h-[300px] w-full">
            <img
            ...
            />
            <div className="absolute inset-0 bg-[#FF7536] bg-opacity-85 text-white lg:p-8 lg:w-[500px] lg:h-[300px] md:p-8 md:w-[350px] md:h-[250px] w-[80%] h-fit py-2 my-auto mx-auto">
              <h1 className="md:text-3xl text-2xl lg:text-5xl font-bold md:mb-4 mb-2 text-center">
                SABRI HELPAGE
              </h1>
        ...
        <div className="flex items-center justify-center lg:h-[450px] md:mt-24 md:mb-10">
